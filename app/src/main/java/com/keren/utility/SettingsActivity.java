...
public class SettingsActivity extends AppCompatActivity
{
    ...
    private EditText nameEditText, phoneEditText, WorkerWorkName;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        WorkerWorkName = findViewById(R.id.worker_work_name);
        if (getType.equals("Workers"))
        {
            WorkerWorkName.setVisibility(View.VISIBLE);
        }
        ...
        closeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                if (getType.equals("Workers"))
                {
                    startActivity(new Intent(SettingsActivity.this, WorkersMapActivity.class));
                }
                else
                {
    ...
    private void validateControllers()
    {
        ...
        else if (getType.equals("Workers")  &&  TextUtils.isEmpty(WorkerWorkName.getText().toString()))
        {
            Toast.makeText(this, "Please provide your work Name.", Toast.LENGTH_SHORT).show();
        }
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task)
                {
                    if (task.isSuccessful())
                    {
                        ...
                        if (getType.equals("Workers"))
                        {
                            userMap.put("work", WorkerWorkName.getText().toString());
                        }
